...
async function main() {
  ...
  for (const t of templates) {
    ...
    await db.taskTemplate.upsert({
      where: { code: t.code },
      update: { triggerEvent: t.triggerEvent ?? null }, // keep the event→template mapping in sync
